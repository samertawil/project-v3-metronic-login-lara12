...
class ForgetPassword extends Component
{
    ...
    {
        //check choose check_type to get type (email or questions)
        $this->typeValue = $prop;
    }
    ...
    public function user(): mixed
    {
        ...
        if ($user) {
           ...
           $userQuestions =  RecoveryAnswerRepository::getRecoveryAnswersByUserId($user->id);
            ...
            if (($userQuestions->isEmpty())) {
                ...
                $this->question1 = $userQuestions[0]->answer ?? '';
                $this->question2 = $userQuestions[1]->answer ?? '';
                $this->question3 = $userQuestions[2]->answer ?? '';
    ...
    //    dd($userQuestions[0]);
        if (
            $this->answer1 == $this->data['questionsData'][0]
            && $this->answer2 == $this->data['questionsData'][1]
            && $this->answer3 == $this->data['questionsData'][2]
        ) {
