...
class Register extends Component
{
    ...
    public function register(): mixed
    {
        ...
        try {
            /** @var User $user */
            $user = UserRepository::registerNewUsers($data);

            $recoveryQuestionsData = ['recoveryQuestions' => $this->recoveryQuestions, 'answers' => $this->answers, 'user_id' => $user->id];

            RecoveryAnswerRepository::storeRecoveryAnswers($recoveryQuestionsData);
    ...
    public function render(): View
    {
        ...
        return view('livewire.login.register')->layoutData(['title' => $title]);
    }
}
