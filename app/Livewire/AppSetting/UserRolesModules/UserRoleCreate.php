...
namespace App\Livewire\AppSetting\UserRolesModules;
 ...
 */
  ...
  public function store(): void
  {
    ...
    $this->redirectRoute('appsetting.user.index');
  }
  ...
  public function render(): View
  {
    ...
    return view('livewire.app-setting.user-roles.user-role-create', compact('roles_group'))->layoutData(['pageTitle' => $pageTitle, 'title' => $pageTitle]);
  }
}
