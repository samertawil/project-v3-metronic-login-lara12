        ...
        <div id="kt_aside_menu" class="aside-menu my-4 " data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav ">
                <li class="menu-item  menu-item-active" aria-haspopup="true"><a
                        href="{{ route(config('uilogin.redirectTo')) }}" wire:navigate class="menu-link "><span
                            ...
                            class="menu-text">{{ __('customTrans.home page') }}</span></a>
                </li>
                ...
                <ul class="menu-nav py-0">
                    ...
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.managment and control') }}</span><i
                                class="menu-arrow"></i></a>
                        <div class="menu-submenu "><i class="menu-arrow"></i>

                            @can('ability.all.resource')
                                <ul class="menu-subnav">

                                    <li class="menu-item mt-2 " aria-haspopup="true"><a href="{{ route('ability.index') }}"
                                            class="menu-link "><i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.abilities') }}</span></a></li>
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item mt-2 " aria-haspopup="true"><a href="{{ route('role.index') }}"
                                        class="menu-link "><i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                            class="menu-text">{{ __('customTrans.role group') }}</span></a></li>
