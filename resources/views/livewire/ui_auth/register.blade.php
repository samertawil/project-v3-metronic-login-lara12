                        ...
                        <form wire:submit='register'>
                            ...
                            <div class="form-group mb-5" style="position: relative;">
                                <input wire:model.live='passwordConfirmation' name="passwordConfirmation"
                                    ...
                                    class="form-control h-auto form-control-solid py-4 px-8 @error('passwordConfirmation') is-invalid @enderror"
                            ...
                            <div class="form-group d-flex flex-wrap flex-center mt-10">
                                ...
                                <button
                                    class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-2">{{ __('customTrans.register_new_account') }}</button>
