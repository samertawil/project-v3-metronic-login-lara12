        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="mb-0" id="home">
                ...
                <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                    style="background-image: url(website-assets/media/svg/illustrations/landing.svg)">
                    ...
                    <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                        ...
                        <div class="d-flex flex-center flex-wrap position-relative px-5">
                            ...
                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Fujifilm">
                                <img src="website-assets/media/svg/brand-logos/fujifilm.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Vodafone">
                                <img src="website-assets/media/svg/brand-logos/vodafone.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip"
                                title="KPMG International">
                                <img src="website-assets/media/svg/brand-logos/kpmg.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Nasa">
                                <img src="website-assets/media/svg/brand-logos/nasa.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Aspnetzero">
                                <img src="website-assets/media/svg/brand-logos/aspnetzero.svg"
                                    class="mh-30px mh-lg-40px" alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip"
                                title="AON - Empower Results">
                                <img src="website-assets/media/svg/brand-logos/aon.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Hewlett-Packard">
                                <img src="website-assets/media/svg/brand-logos/hp-3.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>

                            <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Truman">
                                <img src="website-assets/media/svg/brand-logos/truman.svg" class="mh-30px mh-lg-40px"
                                    alt="" />
                            </div>
                    ...
                    <div class="row w-100 gy-10 mb-md-20">
                        ...
                        <div class="col-md-4 px-5">
                            ...
                            <div class="text-center mb-10 mb-md-0">
                                <!--begin::Illustration-->
                                <img src="website-assets/media/illustrations/sketchy-1/2.png" class="mh-125px mb-9"
                                    alt="" />
                                <!--end::Illustration-->
                                <!--begin::Heading-->
                        ...
                        <div class="col-md-4 px-5">
                            ...
                            <div class="text-center mb-10 mb-md-0">
                                <!--begin::Illustration-->
                                <img src="website-assets/media/illustrations/sketchy-1/8.png" class="mh-125px mb-9"
                                    alt="" />
                                <!--end::Illustration-->
                                <!--begin::Heading-->
                                <div class="d-flex flex-center mb-5">
                        ...
                        <div class="col-md-4 px-5">
                            ...
                            <div class="text-center mb-10 mb-md-0">
                                <!--begin::Illustration-->
                                <img src="website-assets/media/illustrations/sketchy-1/12.png" class="mh-125px mb-9"
                                    alt="" />
                                <!--end::Illustration-->
                                <!--begin::Heading-->
                                <div class="d-flex flex-center mb-5">
...
[$__name, $__params] = $__split('Website.Cards', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3253683042-0', $__slots ?? [], get_defined_vars());
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex flex-center">
                            ...
                            <div
                                ...
                                <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                    style="background-image: url('website-assets/media/svg/misc/octagon.svg')">
                                    <!--begin::Symbol-->
                        ...
                        <div class="fs-2 fw-bold text-muted text-center">
                            <a href="../../demo1/dist/account/security.html"
                                class="link-primary fs-4 fw-bolder">Marcus
                                Levy,</a>
                        ...
                        <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                            ...
                            <div class="text-center">
                                ...
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-2.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-3.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-4.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-5.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-6.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-7.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                            ...
                            <div class="text-center">
                                <!--begin::Photo-->
                                <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('website-assets/media/avatars/150-8.jpg')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay h-lg-100"
                                                ...
                                                href="website-assets/media/stock/600x600/img-23.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                    style="background-image:url('website-assets/media/stock/600x600/img-23.jpg')">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="website-assets/media/stock/600x600/img-22.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image:url('website-assets/media/stock/600x600/img-22.jpg')">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="website-assets/media/stock/600x600/img-21.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image:url('website-assets/media/stock/600x600/img-21.jpg')">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <a class="d-block card-rounded overlay"
                                                data-fslightbox="lightbox-projects"
                                                href="website-assets/media/stock/600x400/img-20.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                    style="background-image:url('website-assets/media/stock/600x600/img-20.jpg')">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="tab-pane fade" id="kt_landing_projects_web_design">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay h-lg-100"
                                                data-fslightbox="lightbox-projects"
                                                href="website-assets/media/stock/600x600/img-11.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                    style="background-image:url('website-assets/media/stock/600x600/img-11.jpg')">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="website-assets/media/stock/600x600/img-12.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image:url('website-assets/media/stock/600x600/img-12.jpg')">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="d-block card-rounded overlay"
                                                        data-fslightbox="lightbox-projects"
                                                        href="website-assets/media/stock/600x600/img-16.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                            style="background-image:url('website-assets/media/stock/600x600/img-16.jpg')">
                                                        </div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <a class="d-block card-rounded overlay"
                                                data-fslightbox="lightbox-projects"
                                                href="website-assets/media/stock/600x400/img-15.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                    style="background-image:url('website-assets/media/stock/600x600/img-15.jpg')">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="tab-pane fade" id="kt_landing_projects_development">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay h-lg-100"
                                                data-fslightbox="lightbox-projects"
                                                href="website-assets/media/stock/600x600/img-15.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                    style="background-image:url('website-assets/media/stock/600x600/img-15.jpg')">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="d-block card-rounded overlay"
                                                data-fslightbox="lightbox-projects"
                                                href="website-assets/media/stock/600x400/img-14.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                    style="background-image:url('website-assets/media/stock/600x600/img-14.jpg')">
                                                </div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="website-assets/media/avatars/150-2.jpg" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="website-assets/media/avatars/150-3.jpg" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="website-assets/media/avatars/150-18.jpg" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic-login-lara12\resources\views/livewire/website/index.blade.php ENDPATH**/ ?>