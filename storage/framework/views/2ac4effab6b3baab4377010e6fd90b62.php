...
[$__name, $__params] = $__split('MyApp.Cards.Create', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1044837208-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'livewire-filepond::upload','data' => ['name' => 'card_img','required' => 'true','wire:model' => 'card_img','allowFileSizeValidation' => true,'maxFileSize' => '1024KB','class' => '<!--[if BLOCK]><![endif]-->@error(\'card_img\') is-invalid   @enderror']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'card_img','required' => 'true','wire:model' => 'card_img','allowFileSizeValidation' => true,'maxFileSize' => '1024KB','class' => '@error(\'card_img\') is-invalid   @enderror']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic-login-lara12\resources\views/livewire/my-app/cards/resource.blade.php ENDPATH**/ ?>