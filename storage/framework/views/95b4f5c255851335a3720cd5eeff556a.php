...
<?php $__env->startPush('css'); ?>
    <link href="<?php echo e(asset('template-assets/metronic7/css/pages/wizard/wizard-1.rtl.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopPush(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <div class="form-group row fv-plugins-icon-container has-success">
                                        <label
                                            class="col-xl-3 col-lg-3 col-form-label"><?php echo e(__('customTrans.email')); ?></label>
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="input-group input-group-lg input-group-solid">
                                                <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="input-group input-group-lg input-group-solid">
                                                <input type="text" wire:model='website'
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="companywebsite"
                                                    placeholder="<?php echo e(__('customTrans.web site')); ?>">
...
[$__name, $__params] = $__split('Address2.Create', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-578459267-0', $__slots ?? [], get_defined_vars());
...
?></livewire:Address2.Create>
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            <h4 class="mb-10 font-weight-bold"><?php echo e(__('customTrans.Review your Details and Submit')); ?>
                            ...
                            <table class="w-100">
                                <tbody>
                                    <tr>
                                        <td class="font-weight-bold text-muted"><?php echo e(__('customTrans.contact_type')); ?>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold text-muted ">
                                            <?php echo e(__('customTrans.contact_full_name')); ?> </td>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($personalSide == true): ?>
                                        <tr>
                                            <td class="font-weight-bold text-muted ">
                                                <?php echo e(__('customTrans.first_name')); ?> </td>
                                            <td style="direction: ltr;"> <input
                                                    class="form-control form-control-lg bg-white border-0"
                                        ...
                                        <tr>
                                            <td class="font-weight-bold text-muted ">
                                                <?php echo e(__('customTrans.family_name')); ?> </td>
                                            <td style="direction: ltr;"> <input
                                                    class="form-control form-control-lg bg-white border-0"
                                    ...
                                    <tr>
                                        <td class="font-weight-bold text-muted ">
                                            <?php echo e(__('customTrans.phone_primary')); ?> </td>
                                        <td style="direction: ltr;"> <input
                                                class="form-control form-control-lg bg-white border-0"
                                    ...
                                    <tr>
                                        <td class="font-weight-bold text-muted ">
                                            <?php echo e(__('customTrans.phone_secondary')); ?> </td>
                                        <td style="direction: ltr;"> <input
                                                class="form-control form-control-lg bg-white border-0"
    ...
    <?php $__env->startPush('js'); ?>
        <script src="<?php echo e(asset('template-assets/metronic7/js/pages/custom/contacts/add-contact.js')); ?>"></script>
    <?php $__env->stopPush(); ?>
</div>
<?php /**PATH C:\xampp\htdocs\project-v3-metronic login-lara12\resources\views/livewire/contact/contact-create.blade.php ENDPATH**/ ?>