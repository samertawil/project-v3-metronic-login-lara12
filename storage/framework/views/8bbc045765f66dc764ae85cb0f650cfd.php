...
<?php $component->withAttributes(['button' => true,'data-target' => '#UserCreateModel1','data-toggle' => 'modal','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('customTrans.create new account'))]); ?>
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('appsetting.user.index')); ?>"
...
[$__name, $__params] = $__split('app-setting.UserModule.register-form');

$__html = app('livewire')->mount($__name, $__params, 'lw-1117792110-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>

                            <td><?php echo e(($this->users->currentPage() - 1) * $this->users->perPage() + $key + 1); ?></td>
...
<?php endif; ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['idName' => 'Userpreview'.e($user->id).'','title' => $user->name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['idName' => 'Userpreview'.e($user->id).'','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->name)]); ?>
                                        ...
                                        <?php echo e($user->need_to_change == 1 ? __('customTrans.yes') : __('customTrans.no')); ?><br><br>

                                        <!--[if BLOCK]><![endif]--><?php if($user->profile_image): ?>
                                            <img src="<?php echo e(asset('storage/' . $user->profile_image)); ?>" width="100">
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu tx-13 ">
                                        <a class="dropdown-item " href="#"
                                            wire:click.prevent='resetPass(<?php echo e($user->id); ?>)'    wire:confirm= "<?php echo e(__("customTrans.are you sure")); ?>"><?php echo e(__('customTrans.request_need_password')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic-login-lara12\resources\views/livewire/app-setting/users/user-index.blade.php ENDPATH**/ ?>