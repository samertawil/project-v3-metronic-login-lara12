    ...
    <div wire:poll.keep-alive.10s="refreshNotifications">
        <div>
            <button class="btn btn-primary" data-toggle="collapse" data-target="#demo">
                <?php echo e(__('customTrans.Notifications')); ?> <span class="badge bg-danger"><?php echo e($notifications->count()); ?></span>
            </button>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item d-flex  justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e($notification->data['url'] ?? '#'); ?>"
                                ...
                                <?php echo e($notification->data['content'] ?? 'No content'); ?>
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic-login-lara12\resources\views/livewire/app-setting/technical-support/show.blade.php ENDPATH**/ ?>