                ...
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin ">
                            <div class="mb-10">
                                <h1><?php echo e(__('customTrans.Sign In To Admin')); ?></h1>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <div class="form-group mb-5">
                                    <input wire:model="password" name="password" dir="ltr"
                                        class="form-control h-auto form-control-solid py-4 m-auto  w-75 w-lg-100 text-center <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <button
                                    class="btn btn-primary font-weight-bold  my-5  w-75"><?php echo e(__('customTrans.Login')); ?></button>
