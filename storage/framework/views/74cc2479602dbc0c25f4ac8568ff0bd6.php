...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <span toggle="#password" class="fa fa-fw fa-eye field-icon toggle-password"
                                    style="position: absolute; top: 50%; right: 5px; transform: translateY(-50%); cursor: pointer; user-select: none;"></span>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="form-group d-flex flex-wrap flex-center mt-10">
                                ...
                                <button
                                    class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-2"><?php echo e(__('customTrans.register_new_account')); ?></button>
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic-login-lara12\resources\views/livewire/login/register.blade.php ENDPATH**/ ?>