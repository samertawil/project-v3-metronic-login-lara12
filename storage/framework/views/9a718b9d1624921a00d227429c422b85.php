...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tag-a','data' => ['route' => route('website'),'name' => __('customTrans.go website'),'defaultClass' => 'btn  btn-light-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('website')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('customTrans.go website')),'default_class' => 'btn  btn-light-primary']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
             ...
             <!--begin::Languages-->
             <?php echo $__env->make('partials.metronic7._lang-metronic-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
             <!--end::Languages-->
             ...
             <div class="topbar-item">
                 <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                     ...
                     <span
                         class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1"><?php echo e(__('customTrans.welcome')); ?></span>
                     <span
                         class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo e(Auth::user()->name ?? __('customTrans.guest')); ?></span>
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic login-lara12\resources\views/partials/metronic7/header-simple.blade.php ENDPATH**/ ?>