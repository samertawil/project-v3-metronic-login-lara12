                ...
                <tbody>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="main-row" wire:key="card-<?php echo e($card->id); ?>">
                            ...
                            <td><?php echo e($card->statusname->status_name ?? ''); ?></td>
                            ...
                            <td class="d-flex ">
                                ...
                                <a href="<?php echo e(asset('website/' . $card->card_img)); ?>" target="_blank"
...
<?php endif; ?>
                                    ...
                                    <div class="my-5">
                                        <a href="<?php echo e(asset('website/' . $this->card_img_show)); ?>" target="_blank"> <img
                                                src="<?php echo e(asset('website/' . $this->card_img_show)); ?>"
...
<?php $__env->startPush('js'); ?>
    <script src="<?php echo e(asset('template-assets/metronic7/js/pages/crud/ktdatatable/advanced/row-details.min.js')); ?>"></script>
