                    ...
                    <div class="col-lg-6 ps-lg-16">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="d-flex fw-bold flex-column ms-lg-20">
                                ...
                                <!--begin::Link-->
                                <a href="#" class="mb-6">
                                    <img src="website-assets/media/svg/brand-logos/facebook-4.svg"
                                ...
                                <!--begin::Link-->
                                <a href="#" class="mb-6">
                                    <img src="website-assets/media/svg/brand-logos/github.svg"
                                        class="h-20px me-2" alt="" />
                                    <span
                                ...
                                <!--begin::Link-->
                                <a href="#" class="mb-6">
                                    <img src="website-assets/media/svg/brand-logos/twitter.svg"
                                        class="h-20px me-2" alt="" />
                                    <span
                                ...
                                <!--begin::Link-->
                                <a href="#" class="mb-6">
                                    <img src="website-assets/media/svg/brand-logos/dribbble-icon-1.svg"
                                        class="h-20px me-2" alt="" />
                                    <span
                                ...
                                <!--begin::Link-->
                                <a href="#" class="mb-6">
                                    <img src="website-assets/media/svg/brand-logos/instagram-2-1.svg"
                                        class="h-20px me-2" alt="" />
                                    <span
                ...
                <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                    ...
                    <div class="d-flex align-items-center order-2 order-md-1">
                        ...
                        <a href="../../demo1/dist/landing.html">
                            <img alt="Logo" src="website-assets/media/logos/logo-landing.svg"
...
<?php /**PATH C:\xampp\htdocs\project-v3-metronic-login-lara12\resources\views/livewire/website/partials/footer.blade.php ENDPATH**/ ?>